...
class PlantFactory:
    """
    Flyweight factory: used to create and manage Plant instances. Keeps track of Plant instances to to ensure that each Plant type is only instantiated once, promoting memory efficiency
    ...
    def get_plant(name: str) -> Optional[Plant]:
        ...
        Preconditions:
            - The name must be one of the predefined plant types                
        Returns:
