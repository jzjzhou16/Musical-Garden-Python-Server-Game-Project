...
class Plant(MapObject):
    ...
    def player_interacted(self, player: HumanPlayer) -> list[Message]:
        ...
        Preconditions:
            - The plant must be passable
        Postconditions:
            - The player is set to carry the plant
            - The pickup command is executed
        
        Returns:
            (list[Message]): Message generated by executing the pickup command
        """
        #precondition
        assert self.__passable, "Plant must be passable to interact with it"
